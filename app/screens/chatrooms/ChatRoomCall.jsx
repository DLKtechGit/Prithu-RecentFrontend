...
const ChatRoomCall = ({ navigation } : ChatRoomCallScreenProps) => {
    ...
    useEffect(()=>{
        setTimeout(() => {
            {navigation.navigate('ChatRoomCallON', {data : data})}
        },3000)
    },[])
        ...
        <SafeAreaView style={[GlobalStyleSheet.container,{ backgroundColor: '#112036', flex: 1,padding:0 }]}>
            ...
            <View style={[GlobalStyleSheet.container,{flex:1,padding:0}]}>
                    ...
                    <View style={{alignItems:'center',marginHorizontal:40}}>
                        ...
                        <View style={{flexDirection:'row',alignItems:'center',gap:10,marginTop:5}}>
                            <Image
                                ...
                                source={IMAGES.call}
                            />
                            <Text style={{...FONTS.fontMedium,fontSize:14,color:COLORS.card,lineHeight:20}}>Call</Text>
                        </View>
                    </View>
                </View>
                <View style={{alignItems:'center',marginBottom:10}}>
                    ...
                    <Text style={{...FONTS.fontMedium,fontSize:15,color:COLORS.card}}>39 Other Participants</Text>
                </View>
