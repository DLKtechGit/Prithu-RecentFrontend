...
const AnotherProfile = () => {
 ...
 const [currentUserId, setCurrentUserId] = useState(null);
  ...
  const [creatorFollowerCount, setcreatorFollowerCount] = useState(0); // New state for followers count
  ...
  const [followingCount, setfollowingCount] = useState(0); // New state for followers count
  ...
  const buildUrl = (path | undefined | null) => {
